Nano_Suit_SPARTAN_V2 ={

SPARTAN_V2_Suit_Active = true;
...
InvisSTOP = 0;
ActiveScan = 0;
FastAsFuckTick = FastAsFuckTickEff_SPARTAN_V2;
GottaGoFastMultiplier = GottaGoFastMultiplierEff_SPARTAN_V2;
GenStopTick = RechargeTick_SPARTAN_V2 + 0.2;
DisengageTick = selectMax [ArmorTick_SPARTAN_V2,SneakTick_SPARTAN_V2,FastAsFuckTick] +0.1;
if (NanoAirburst_SPARTAN_V2) then {ConstantRangefinder_SPARTAN_V2 = true;};
AbiliyActive = 0;
ArmorActive = 0;
InvisActive = 0;
SpeedActive = 0;
...
if (ShotBreakInvis_SPARTAN_V2) then {
  if (InvisBreakRDY == 1) then {
    if (!ExcludeSuppressed_SPARTAN_V2) then {InvisSTOP = 1;} else {
      switch (RecoilConmpensationWeaponType) do
      {
        case "KA_dagger":                 {if (SuitPower_SPARTAN_V2 >= 1)  then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 1;}  else {InvisSTOP = 1;};};
        case "KA_knife":                  {if (SuitPower_SPARTAN_V2 >= 1)  then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 1;}  else {InvisSTOP = 1;};};
        case "KA_machete":                {if (SuitPower_SPARTAN_V2 >= 1)  then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 1;}  else {InvisSTOP = 1;};};
        case "KA_axe":                    {if (SuitPower_SPARTAN_V2 >= 1)  then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 1;}  else {InvisSTOP = 1;};};
        case "Hatchet":                   {if (SuitPower_SPARTAN_V2 >= 1)  then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 1;}  else {InvisSTOP = 1;};};
        case "KA_crossbow_black":         {if (SuitPower_SPARTAN_V2 >= 1)  then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 1;}  else {InvisSTOP = 1;};};
        case "KA_crossbow_wood":          {if (SuitPower_SPARTAN_V2 >= 1)  then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 1;}  else {InvisSTOP = 1;};};
        case "rhs_weap_m3a1_specops":     {if (SuitPower_SPARTAN_V2 >= 5)  then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 5;}  else {InvisSTOP = 1;};};
        case "rhs_weap_pb_6p9":           {if (SuitPower_SPARTAN_V2 >= 10) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 10;} else {InvisSTOP = 1;};};
        case "KA_MP5SD3":                 {if (SuitPower_SPARTAN_V2 >= 10) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 10;} else {InvisSTOP = 1;};};
        case "hlc_smg_mp5sd5":            {if (SuitPower_SPARTAN_V2 >= 10) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 10;} else {InvisSTOP = 1;};};
        case "hlc_smg_mp5sd6":            {if (SuitPower_SPARTAN_V2 >= 10) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 10;} else {InvisSTOP = 1;};};
        case "hlc_rifle_honeybadger":     {if (SuitPower_SPARTAN_V2 >= 20) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 20;} else {InvisSTOP = 1;};};
        case "rhs_weap_asval":            {if (SuitPower_SPARTAN_V2 >= 20) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 20;} else {InvisSTOP = 1;};};
        case "rhs_weap_asval_grip":       {if (SuitPower_SPARTAN_V2 >= 20) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 20;} else {InvisSTOP = 1;};};
        case "rhs_weap_asval_npz":        {if (SuitPower_SPARTAN_V2 >= 20) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 20;} else {InvisSTOP = 1;};};
        case "rhs_weap_asval_grip_npz":   {if (SuitPower_SPARTAN_V2 >= 20) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 20;} else {InvisSTOP = 1;};};
        case "rhs_weap_vss":              {if (SuitPower_SPARTAN_V2 >= 20) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 20;} else {InvisSTOP = 1;};};
        case "rhs_weap_vss_grip":         {if (SuitPower_SPARTAN_V2 >= 20) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 20;} else {InvisSTOP = 1;};};
        case "rhs_weap_vss_npz":          {if (SuitPower_SPARTAN_V2 >= 20) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 20;} else {InvisSTOP = 1;};};
        case "rhs_weap_vss_grip_npz":     {if (SuitPower_SPARTAN_V2 >= 20) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 20;} else {InvisSTOP = 1;};};
        case "hlc_rifle_awcovert":        {if (SuitPower_SPARTAN_V2 >= 30) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 30;} else {InvisSTOP = 1;};};
        case "hlc_rifle_awcovert_FDE":    {if (SuitPower_SPARTAN_V2 >= 30) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 30;} else {InvisSTOP = 1;};};
        case "hlc_rifle_awcovert_BL":     {if (SuitPower_SPARTAN_V2 >= 30) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 30;} else {InvisSTOP = 1;};};
        case "KA_VSSK":                   {if (SuitPower_SPARTAN_V2 >= 30) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 30;} else {InvisSTOP = 1;};};
        case "srifle_DMR_04_F":           {if (SuitPower_SPARTAN_V2 >= 30) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 30;} else {InvisSTOP = 1;};};
        case "srifle_DMR_04_Tan_F":       {if (SuitPower_SPARTAN_V2 >= 30) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 30;} else {InvisSTOP = 1;};};
        case "rhs_weap_m32":              {if (SuitPower_SPARTAN_V2 >= 50) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 50;} else {InvisSTOP = 1;};};
        case "ATA_XM25_F":                {if (SuitPower_SPARTAN_V2 >= 50) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 50;} else {InvisSTOP = 1;};};
        case "ATA_XM29_F":                {
                                              if (RecoilConmpensationMuzzleType == "ATA_XM29_F") then{
                                                  if (SuitPower_SPARTAN_V2 >= 50) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 50;} else {InvisSTOP = 1;};
                                              } else {
                                                  if ("XM29_KE_Suppressor" in (player weaponAccessories primaryWeapon player)) then{
                                                      if (SuitPower_SPARTAN_V2 >= 30) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 30;} else {InvisSTOP = 1;};
                                                  } else {
                                                      InvisSTOP = 1;
                                                  };
                                              };
  ...
  switch (RecoilConmpensationWeaponType) do
  {
    case "LAGO_KU3K":                 {    comment "These weapons (KU3 and KU5) have different accuracy in different firemodes so energy consumtion balanced accordingly.";
      switch (RecoilConmpensationFiremodeType) do {
        case "Single":     {if (SuitPower_SPARTAN_V2 >= 5) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 5;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
        case "Burst":      {if (SuitPower_SPARTAN_V2 >= 3) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 3;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
        case "FullAuto":   {if (SuitPower_SPARTAN_V2 >= 2) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 2;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
      };
    };
    case "LAGO_KU5K":                 {
      switch (RecoilConmpensationFiremodeType) do {
        case "FullAuto1":   {if (SuitPower_SPARTAN_V2 >= 3) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 3;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
        case "FullAuto2":   {if (SuitPower_SPARTAN_V2 >= 2) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 2;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
      };
    };
    case "LAGO_KU98K_NSK":            {if (SuitPower_SPARTAN_V2 >= 10) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 10;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    case "LAGO_CP":                   {};
    case "weap_RPK":                  {if (SuitPower_SPARTAN_V2 >= 4) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 4;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    case "rhs_weap_SCARL_CQC":        {if (SuitPower_SPARTAN_V2 >= 4) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 4;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    case "rhs_weap_SCARL_FDE_CQC":    {if (SuitPower_SPARTAN_V2 >= 4) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 4;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    case "rhs_weap_SCARL_LB":         {if (SuitPower_SPARTAN_V2 >= 4) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 4;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    case "rhs_weap_SCARL_FDE_LB":     {if (SuitPower_SPARTAN_V2 >= 4) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 4;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    case "rhs_weap_SCARL_STD":        {if (SuitPower_SPARTAN_V2 >= 4) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 4;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    case "rhs_weap_SCARL_FDE_STD":    {if (SuitPower_SPARTAN_V2 >= 4) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 4;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    case "KA_SCAR_H_Black_Hand":      {if (SuitPower_SPARTAN_V2 >= 6) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 6;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    case "KA_SCAR_H_Black_AFG":       {if (SuitPower_SPARTAN_V2 >= 6) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 6;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    case "KA_SCAR_H_Black_EGLM":      {if (SuitPower_SPARTAN_V2 >= 6) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 6;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    case "KA_SCAR_H_Black_Grip":      {if (SuitPower_SPARTAN_V2 >= 6) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 6;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    case "KA_SCAR_H_Tan_Hand":        {if (SuitPower_SPARTAN_V2 >= 6) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 6;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    case "KA_SCAR_H_Tan_AFG":         {if (SuitPower_SPARTAN_V2 >= 6) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 6;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    case "KA_SCAR_H_Tan_EGLM":        {if (SuitPower_SPARTAN_V2 >= 6) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 6;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    case "KA_SCAR_H_Tan_Grip":        {if (SuitPower_SPARTAN_V2 >= 6) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 6;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
    default                           {if (SuitPower_SPARTAN_V2 >= RecoilConmpensationEnergyPerShot_SPARTAN_V2) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - RecoilConmpensationEnergyPerShot_SPARTAN_V2;} else {SuitPower_SPARTAN_V2 = 0; playSound "Alarm"; [] call Nano_AIM;};};
  };
};
...
if (NanoGuidance_SPARTAN_V2) then {
...
SuppressorCheck = {
  ...
  _AttachmentsArray = _this select 0;
    ...
    ) then { if (SuitPower_SPARTAN_V2 >= 30) then{SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 30; } else {InvisSTOP = 1;};} else {InvisSTOP = 1;};
};

  comment "Adding eventHandler for proximity sensor if needed.";
if (ProximitySensor_SPARTAN_V2) then {
...
MEH_HUD = addMissionEventHandler ["EachFrame", {
  ...
  if (SuitPower_SPARTAN_V2 >= 0 ) then {ChargeGraph = "[..................................................]"};
  if (SuitPower_SPARTAN_V2 >= 2 ) then {ChargeGraph = "[|.................................................]"};
  if (SuitPower_SPARTAN_V2 >= 4 ) then {ChargeGraph = "[||................................................]"};
  if (SuitPower_SPARTAN_V2 >= 6 ) then {ChargeGraph = "[|||...............................................]"};
  if (SuitPower_SPARTAN_V2 >= 8 ) then {ChargeGraph = "[||||..............................................]"};
  if (SuitPower_SPARTAN_V2 >= 10) then {ChargeGraph = "[|||||.............................................]"};
  if (SuitPower_SPARTAN_V2 >= 12) then {ChargeGraph = "[||||||............................................]"};
  if (SuitPower_SPARTAN_V2 >= 14) then {ChargeGraph = "[|||||||...........................................]"};
  if (SuitPower_SPARTAN_V2 >= 16) then {ChargeGraph = "[||||||||..........................................]"};
  if (SuitPower_SPARTAN_V2 >= 18) then {ChargeGraph = "[|||||||||.........................................]"};
  if (SuitPower_SPARTAN_V2 >= 20) then {ChargeGraph = "[||||||||||........................................]"};
  if (SuitPower_SPARTAN_V2 >= 22) then {ChargeGraph = "[|||||||||||.......................................]"};
  if (SuitPower_SPARTAN_V2 >= 24) then {ChargeGraph = "[||||||||||||......................................]"};
  if (SuitPower_SPARTAN_V2 >= 26) then {ChargeGraph = "[|||||||||||||.....................................]"};
  if (SuitPower_SPARTAN_V2 >= 28) then {ChargeGraph = "[||||||||||||||....................................]"};
  if (SuitPower_SPARTAN_V2 >= 30) then {ChargeGraph = "[|||||||||||||||...................................]"};
  if (SuitPower_SPARTAN_V2 >= 32) then {ChargeGraph = "[||||||||||||||||..................................]"};
  if (SuitPower_SPARTAN_V2 >= 34) then {ChargeGraph = "[|||||||||||||||||.................................]"};
  if (SuitPower_SPARTAN_V2 >= 36) then {ChargeGraph = "[||||||||||||||||||................................]"};
  if (SuitPower_SPARTAN_V2 >= 38) then {ChargeGraph = "[|||||||||||||||||||...............................]"};
  if (SuitPower_SPARTAN_V2 >= 40) then {ChargeGraph = "[||||||||||||||||||||..............................]"};
  if (SuitPower_SPARTAN_V2 >= 42) then {ChargeGraph = "[|||||||||||||||||||||.............................]"};
  if (SuitPower_SPARTAN_V2 >= 44) then {ChargeGraph = "[||||||||||||||||||||||............................]"};
  if (SuitPower_SPARTAN_V2 >= 46) then {ChargeGraph = "[|||||||||||||||||||||||...........................]"};
  if (SuitPower_SPARTAN_V2 >= 48) then {ChargeGraph = "[||||||||||||||||||||||||..........................]"};
  if (SuitPower_SPARTAN_V2 >= 50) then {ChargeGraph = "[|||||||||||||||||||||||||.........................]"};
  if (SuitPower_SPARTAN_V2 >= 52) then {ChargeGraph = "[||||||||||||||||||||||||||........................]"};
  if (SuitPower_SPARTAN_V2 >= 54) then {ChargeGraph = "[|||||||||||||||||||||||||||.......................]"};
  if (SuitPower_SPARTAN_V2 >= 56) then {ChargeGraph = "[||||||||||||||||||||||||||||......................]"};
  if (SuitPower_SPARTAN_V2 >= 58) then {ChargeGraph = "[|||||||||||||||||||||||||||||.....................]"};
  if (SuitPower_SPARTAN_V2 >= 60) then {ChargeGraph = "[||||||||||||||||||||||||||||||....................]"};
  if (SuitPower_SPARTAN_V2 >= 62) then {ChargeGraph = "[|||||||||||||||||||||||||||||||...................]"};
  if (SuitPower_SPARTAN_V2 >= 64) then {ChargeGraph = "[||||||||||||||||||||||||||||||||..................]"};
  if (SuitPower_SPARTAN_V2 >= 66) then {ChargeGraph = "[|||||||||||||||||||||||||||||||||.................]"};
  if (SuitPower_SPARTAN_V2 >= 68) then {ChargeGraph = "[||||||||||||||||||||||||||||||||||................]"};
  if (SuitPower_SPARTAN_V2 >= 70) then {ChargeGraph = "[|||||||||||||||||||||||||||||||||||...............]"};
  if (SuitPower_SPARTAN_V2 >= 72) then {ChargeGraph = "[||||||||||||||||||||||||||||||||||||..............]"};
  if (SuitPower_SPARTAN_V2 >= 74) then {ChargeGraph = "[|||||||||||||||||||||||||||||||||||||.............]"};
  if (SuitPower_SPARTAN_V2 >= 76) then {ChargeGraph = "[||||||||||||||||||||||||||||||||||||||............]"};
  if (SuitPower_SPARTAN_V2 >= 78) then {ChargeGraph = "[|||||||||||||||||||||||||||||||||||||||...........]"};
  if (SuitPower_SPARTAN_V2 >= 80) then {ChargeGraph = "[||||||||||||||||||||||||||||||||||||||||..........]"};
  if (SuitPower_SPARTAN_V2 >= 82) then {ChargeGraph = "[|||||||||||||||||||||||||||||||||||||||||.........]"};
  if (SuitPower_SPARTAN_V2 >= 84) then {ChargeGraph = "[||||||||||||||||||||||||||||||||||||||||||........]"};
  if (SuitPower_SPARTAN_V2 >= 86) then {ChargeGraph = "[|||||||||||||||||||||||||||||||||||||||||||.......]"};
  if (SuitPower_SPARTAN_V2 >= 88) then {ChargeGraph = "[||||||||||||||||||||||||||||||||||||||||||||......]"};
  if (SuitPower_SPARTAN_V2 >= 90) then {ChargeGraph = "[|||||||||||||||||||||||||||||||||||||||||||||.....]"};
  if (SuitPower_SPARTAN_V2 >= 92) then {ChargeGraph = "[||||||||||||||||||||||||||||||||||||||||||||||....]"};
  if (SuitPower_SPARTAN_V2 >= 94) then {ChargeGraph = "[|||||||||||||||||||||||||||||||||||||||||||||||...]"};
  if (SuitPower_SPARTAN_V2 >= 96) then {ChargeGraph = "[||||||||||||||||||||||||||||||||||||||||||||||||..]"};
  if (SuitPower_SPARTAN_V2 >= 98) then {ChargeGraph = "[|||||||||||||||||||||||||||||||||||||||||||||||||.]"};
  if (SuitPower_SPARTAN_V2 >= 100) then {ChargeGraph= "[||||||||||||||||||||||||||||||||||||||||||||||||||]"};

      comment "Rangefinder.";
    if (ConstantRangefinder_SPARTAN_V2) then {
    ...
    if (NanoHeal_SPARTAN_V2) then {Health = 100-((damage player)*100);};

      comment "Not letting players see negative power values when manual stop used.";
    if (SuitPower_SPARTAN_V2 < -0.01) then {UISuitPower = "Reboot"} else {UISuitPower = (selectMin [100,SuitPower_SPARTAN_V2]) toFixed 1;};

  comment "Information output.";
  if (nanite_new_UI_SPARTAN_V2) then {
    ...
    _set_bar progressSetPosition (SuitPower_SPARTAN_V2/100);

    if (!nanite_GUI_HidePercentage_SPARTAN_V2) then {
    ...
    if ((!NanoAirburst_SPARTAN_V2)and(!NanoHeal_SPARTAN_V2)and(!ConstantRangefinder_SPARTAN_V2)) then {hintSilent formatText ["Power: %1 %2%3%4", UISuitPower, "%", lineBreak,ChargeGraph];};
    if ((!NanoAirburst_SPARTAN_V2)and(!NanoHeal_SPARTAN_V2)and(ConstantRangefinder_SPARTAN_V2)) then {hintSilent formatText ["Power: %1 %2%3%4%3Distance: %5 m", UISuitPower, "%", lineBreak ,ChargeGraph, DisMes];};
    if ((!NanoAirburst_SPARTAN_V2)and(NanoHeal_SPARTAN_V2)and(!ConstantRangefinder_SPARTAN_V2)) then {hintSilent formatText ["Power: %1 %2%3%4%3User health: %5 %2", UISuitPower, "%", lineBreak, ChargeGraph, Health];};
    if ((!NanoAirburst_SPARTAN_V2)and(NanoHeal_SPARTAN_V2)and(ConstantRangefinder_SPARTAN_V2)) then {hintSilent formatText ["Power: %1 %2%3%4%3Distance: %5 m%3User health: %6 %2", UISuitPower, "%", lineBreak, ChargeGraph, DisMes, Health];};
    if ((NanoAirburst_SPARTAN_V2)and(!NanoHeal_SPARTAN_V2)and(!ConstantRangefinder_SPARTAN_V2)) then {hint "Something really went wrong if you see this. That shouldn't be possible.";};
    if ((NanoAirburst_SPARTAN_V2)and(!NanoHeal_SPARTAN_V2)and(ConstantRangefinder_SPARTAN_V2)) then {hintSilent formatText ["Power: %1 %2%3%4%3Distance: %5 m%3Airburst: %6 m", UISuitPower, "%", lineBreak ,ChargeGraph, DisMes,DisLockedUI];};
    if ((NanoAirburst_SPARTAN_V2)and(NanoHeal_SPARTAN_V2)and(!ConstantRangefinder_SPARTAN_V2)) then {hint "Something really went wrong if you see this. That shouldn't be possible.";};
    if ((NanoAirburst_SPARTAN_V2)and(NanoHeal_SPARTAN_V2)and(ConstantRangefinder_SPARTAN_V2)) then {hintSilent formatText ["Power: %1 %2%3%4%3Distance: %5 m%3Airburst: %6 m%3User health: %7 %2", UISuitPower, "%", lineBreak, ChargeGraph, DisMes, DisLockedUI, Health];};
  };
  comment "Rebreather module.";
  if (NanoRebreather_SPARTAN_V2) then {player setOxygenRemaining 1;};
...
NanoActivateActionID = player addAction ["<t>Activate Suit</t>", {
  if (!DisableScrollMenu_SPARTAN_V2) then {
    [] call Nano_menu2eff;
...
fnc_shield_size_switch_addaction = {
  ...
  shield_switch_action_id = player addAction[format["<t color='#C4CACE'>>>Shield Size %1</t>",(["[ >SINGLE | GROUP ]","[ SINGLE | >GROUP ]"] select shield_size_switch)],{if (shield_size_switch == 0) then {shield_size_switch = 1} else {shield_size_switch = 0}; Nano_menu2effHidden;   if (FastAsFuckTick == FastAsFuckTickMAX_SPARTAN_V2) then {[] call Nano_menu2eff;}else {[] call Nano_menu2max;};}, nil, 1.5, true, false, "", "true", 50, false, "", ""];
};

Nano_menu2eff = {
  removeallactions player;
   if (MaximumArmorSwitch_SPARTAN_V2)     then {player addAction ["<t color='#C4CACE'>>>Maximum Armor</t>", {[] call Nano_Armor2_ACT;}, nil, 1.5, true, false, "", "true", 50, false, "", ""];};
   if (shield_size_switch_SPARTAN_V2) then {player call fnc_shield_size_switch_addaction;};

   if (CloakSwitch_SPARTAN_V2)            then {player addAction ["<t color='#606060'>>>Engage Cloak</t>", {[] call Nano_Sneak2_ACT;}, nil, 1.5, true, false, "", "true", 50, false, "", ""];};
   if (MaximumSpeedSwitch_SPARTAN_V2)    then {player addAction ["<t color='#FF0000'>>>Maximum Speed</t>", {[] call Nano_FAFB2_ACT;}, nil, 1.5, true, false, "", "true", 50, false, "", ""];};
                                          player addAction ["<t>>Disengage abilities</t>", {[] call Nano_STOP_ACT;}, nil, 1.5, true, false, "", "true", 50, false, "", ""];
   if (JumpSwitch_SPARTAN_V2)             then {player addAction ["<t>^Jump^</t>", {[] call Nano_JUMP;}, nil, 1.5, true, false, "", "true", 50, false, "", ""];};
   if (WeaponHandlingSwitch_SPARTAN_V2)   then {player addAction ["<t>>Weapon handling</t>", {[] call Nano_AIM;}, nil, 1.5, true, false, "", "true", 50, false, "", ""];};
   if (TwoSpeedModeSwitch_SPARTAN_V2)    then {player addAction ["<t>Speed mode switch [ >Eff | MAX ]</t>", {FastAsFuckTick = FastAsFuckTickMAX_SPARTAN_V2; GottaGoFastMultiplier = GottaGoFastMultiplierMAX_SPARTAN_V2; DisengageTick = selectMax [ArmorTick_SPARTAN_V2,SneakTick_SPARTAN_V2,FastAsFuckTick] +0.1; [] call Nano_menu2max;}, nil, 1.5, true, false, "", "true", 50, false, "", ""];};
   if (NanoAirburst_SPARTAN_V2)           then {player addAction ["<t>Switch airburst ON/OFF</t>", {if (ABswitch == 0) then{ABswitch = 1;}else{ABswitch = 0;};}, nil, 1.5, true, false, "", "true", 50, false, "", ""];};
                                          player addAction ["<t color='#BBBBBB'>>>Hide menu</t>", {[] call Nano_menu2effHidden;}];
   if (JumpSwitch_SPARTAN_V2)             then {player addAction ["<t color='#ff6700'>[Manual debug]</t><t> Unstuck (don't use jump in buildings next time)</t>", {player setVelocity [0,0,0];}, nil, 1.5, true, false, "", "true", 50, false, "", ""];};
...
Nano_menu2max = {
  removeallactions player;
     ...
     if (JumpSwitch_SPARTAN_V2)             then {player addAction ["<t>^Jump^</t>", {[] call Nano_JUMP;}, nil, 1.5, true, false, "", "true", 50, false, "", ""];};
     if (WeaponHandlingSwitch_SPARTAN_V2)   then {player addAction ["<t>>Weapon handling</t>", {[] call Nano_AIM;}, nil, 1.5, true, false, "", "true", 50, false, "", ""];};
                                            player addAction ["<t>Speed mode switch [ Eff | >MAX ]</t>", {FastAsFuckTick = FastAsFuckTickEff_SPARTAN_V2; GottaGoFastMultiplier = GottaGoFastMultiplierEff_SPARTAN_V2; DisengageTick = selectMax [ArmorTick_SPARTAN_V2,SneakTick_SPARTAN_V2,FastAsFuckTick] +0.1; [] call Nano_menu2eff;}];
     if (NanoAirburst_SPARTAN_V2)           then {player addAction ["<t>Switch airburst ON/OFF</t>", {if (ABswitch == 0) then{ABswitch = 1;}else{ABswitch = 0;};}, nil, 1.5, true, false, "", "true", 50, false, "", ""];};
...
SuitGenerator = {
    if (SuitPower_SPARTAN_V2 < 100) then {
        if (AbiliyActive == 0) then {
          SuitPower_SPARTAN_V2 = round (SuitPower_SPARTAN_V2 + 1);
          PlayerSpeedPower = (((abs(velocity player select 0)) + (abs(velocity player select 1)) + (abs(velocity player select 2)))*3.6);
          if ((StaticRecharge_SPARTAN_V2)and(PlayerSpeedPower == 0) and(SuitPower_SPARTAN_V2 < 100)) then {SuitPower_SPARTAN_V2 = round (SuitPower_SPARTAN_V2 + 1);};
          uiSleep RechargeTick_SPARTAN_V2;
        };
        if (Cease == 0) then {[] call SuitGenerator;};
          }
          else {
            uiSleep 1;
            if (NanoHeal_SPARTAN_V2) then {player setDamage ((getDammage player) - NanoHealRate_SPARTAN_V2);};
            if (Cease == 0) then {[] call SuitGenerator;};
          };
  };
...
GeneratorScan = {
  if ((SuitPower_SPARTAN_V2 < 50) and (SuitPower_SPARTAN_V2 >= -1)) then {
    SuitPowerACCBRK = SuitPower_SPARTAN_V2;
    ActiveScan = 1;
      for [{_i = 0}, {_i < 10}, {_i = _i + 1}] do {
        SuitPowerACCBRK = round (SuitPowerACCBRK + 1);
        if ((StaticRecharge_SPARTAN_V2)and(PlayerSpeedPower == 0) and(SuitPowerACCBRK < 100)) then {SuitPowerACCBRK = round (SuitPowerACCBRK + 1);};
        uiSleep RechargeTick_SPARTAN_V2;
      };
    ActiveScan = 0;
    if ((SuitPower_SPARTAN_V2 - SuitPowerACCBRK)>8) then {
      [] call GeneratorStop;
...
GeneratorRestart = {
  if (SuitPower_SPARTAN_V2 != 100) then{
  SuitPowerACCDEB = SuitPower_SPARTAN_V2;
  uiSleep (RechargeTick_SPARTAN_V2 * 3);
    if (SuitPower_SPARTAN_V2 == SuitPowerACCDEB) then {
...
Nano_Armor2_ACT = {
  if (SuitPower_SPARTAN_V2 >= 10) then {
    if (ArmorActive == 0) then {
      systemChat "Maximum armor";
      playSound "Hint";
      if (shield_switch_SPARTAN_V2) then {
        [] call Nano_Shield;
      }
      else {
        [] call Nano_Armor2;
...
Nano_Armor2 = {
  if (SuitPower_SPARTAN_V2 > 0) then {
    ...
    if (!ActiveRecharge_SPARTAN_V2) then {AbiliyActive = 1;};
    ArmorActive = 1;
    SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 1;
    player allowDamage false;
    uiSleep ArmorTick_SPARTAN_V2;
    [] call Nano_Armor2;
  } else {
    if (SuitPower_SPARTAN_V2 > -5) then {systemChat "Out of energy"; playSound "Alarm";};
    ArmorActive = 0;
    AbiliyActive = 0;
...
Nano_Shield = {
  if (SuitPower_SPARTAN_V2 > 0) then {
    ...
    if (ArmorActive == 0) then {
      if (player == vehicle player) then {
        if (shield_size_switch == 0) then {
          ...
          _player_shield setObjectScale eta_small_shield_size_SPARTAN_V2;
          shield_power_drain = eta_small_shield_power_drain_SPARTAN_V2;
        };
        if (shield_size_switch == 1) then {
          _player_shield = createVehicle ["OPTRE_FC_Energy_shield", position player, [], 0, "CAN_COLLIDE"];
          _player_shield attachTo [player, [0, 0, 1]];
          _player_shield setObjectScale eta_big_shield_size_SPARTAN_V2;
          shield_power_drain = eta_big_shield_power_drain_SPARTAN_V2;
        };
      }
      else {
        if (eta_vehicle_shield_SPARTAN_V2) then
        {
          ...
          shield_power_drain = eta_vehicle_shield_power_drain_SPARTAN_V2;
    ...
    ArmorActive = 1;
    SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - shield_power_drain;
    uiSleep ArmorTick_SPARTAN_V2;
    [] call Nano_Shield;
  } else {
    if (SuitPower_SPARTAN_V2 > -5) then {systemChat "Out of energy"; playSound "Alarm";};
  ...
  if (SuitPower_SPARTAN_V2 >= 10) then {
    if (InvisActive == 0) then {
      if (player getVariable ["_eta_cloak_cooldown", true]) then {
        ...
        sleep eta_sneak_chargeup_SPARTAN_V2;
    ...
    if (InvisSTOP == 0) then{
        if (SuitPower_SPARTAN_V2 > 0) then {
              ...
              if (eta_cloak_vehicles_SPARTAN_V2) then {
                if (InvisActive == 0) then {
                  ...
                  _player_stealth_vehicle_exit_EH = player addEventHandler ["GetOutMan",
                  {
                     ...
                     if (eta_nanite_cloak_particles_SPARTAN_V2) then {
            ...
            else
            {
              ...
              if (AdvancedInvisibility_SPARTAN_V2) then {
                ...
                SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - 1;
                if (vehicle player != player) then {
                  SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - eta_vehicle_stealth_energy_cost_SPARTAN_V2;
                };
        ...
        InvisSTOP = 0;
        if (TextureHandling) then {player setObjectTextureGlobal [0,TextureIdle];};
        if (AndZeroPower_SPARTAN_V2) then {SuitPower_SPARTAN_V2 = 0;};
    };
  };
    };
...
Nano_JUMP = {
  if ((vehicle player) == player) then{
    if (isTouchingGround player) then {
      if (SuitPower_SPARTAN_V2 >= JumpEnergyCost_SPARTAN_V2) then {
        player setVelocity [(velocity player select 0),(velocity player select 1), 20];
        SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - JumpEnergyCost_SPARTAN_V2;
        if (ActiveScan == 0) then {[] spawn{[] call GeneratorScan;};};
...
Nano_AIM = {
  if(isNil "NanoAIMSW") then {NanoAIMSW = 0};
    if (NanoAIMSW == 0) then{
      if (SuitPower_SPARTAN_V2 >= 10) then {
        NanoAIMSW = 1;
         if (WeaponCoreNoSway_SPARTAN_V2) then{
          MEH_NoSway = addMissionEventHandler ["EachFrame", {player setCustomAimCoef WeaponCoreSwayMultiplier_SPARTAN_V2;}];
          };
        if (WeaponCoreNoRecharge_SPARTAN_V2) then {AbiliyActive = 1;};
        if (TraceBullets_SPARTAN_V2) then {[player, TraceNumber_SPARTAN_V2] spawn BIS_fnc_traceBullets;};
        player setUnitRecoilCoefficient RecoilModificator_SPARTAN_V2;
      ...
      NanoAIMSW = 0;
      removeMissionEventHandler ["EachFrame", MEH_NoSway];
      if (WeaponCoreNoRecharge_SPARTAN_V2) then {AbiliyActive = 0;};
          [] spawn {
              if (TraceBullets_SPARTAN_V2) then {sleep 0.4;[player, 0] spawn BIS_fnc_traceBullets;};
          };
...
Nano_Shield_Charge = {
  if (SuitPower_SPARTAN_V2 >= eta_energy_shield_recharge_cost_SPARTAN_V2) then {
    player setVariable ["optre_stopcharging", false, true];
    _optre_suit_energy = player getVariable ["optre_suit_energy", 100];
    _new_suit_energy = _optre_suit_energy + eta_energy_shield_recharge_amount_SPARTAN_V2;
    if (_new_suit_energy > 100) then {_new_suit_energy = 100};
    player setVariable ["optre_suit_energy", _new_suit_energy, true];
    SuitPower_SPARTAN_V2 = SuitPower_SPARTAN_V2 - eta_energy_shield_recharge_cost_SPARTAN_V2;
...
Nano_STOP = {
  ...
  [] spawn {
    ...
    sleep eta_cloak_cooldown_timer_SPARTAN_V2;
    player setVariable ["_eta_cloak_cooldown", true, true];
  };
  {
    if (_x isKindOf "OPTRE_FC_Energy_shield") then {
  ...
  if(isNil "NanoAIMSW") then {NanoAIMSW = 0};
  onEachFrame{};
  if (TraceBullets_SPARTAN_V2) then {[player, 0] spawn BIS_fnc_traceBullets;};
  uiSleep 0.01;
  if ((TraceBullets_SPARTAN_V2) and (NanoAIMSW == 1)) then {[player, TraceNumber_SPARTAN_V2] spawn BIS_fnc_traceBullets;};
  player allowDamage true;
  ...
  SuitPower_SPARTAN_V2 = SuitPowerACC;
  uiSleep 0.02;
  NanoStopping = 0;
  if (TextureHandling) then {player setObjectTextureGlobal [0,TextureIdle];};
};
